...
WinRAR.exe A "%~dp0\SkBK.rar" Skype u –r -inul -m5 -agYYYYMMDD-nn

::加入註解與修復紀錄3%
cd "%~dp0"
Echo SkypePatch = "%%USERPROFILE%%\AppData\Roaming\Skype" > SkypePatch.txt
WinRAR.exe c -zSkypePatch.txt SkBK.rar -agYYYYMMDD-nn
WinRAR.exe rr3p SkBK.rar -agYYYYMMDD-nn

::解壓縮檔案到指定位置
cd "%USERPROFILE%\AppData\Roaming\"
WinRAR.exe x "%~dp0\*Skype*.rar" -r -o+
