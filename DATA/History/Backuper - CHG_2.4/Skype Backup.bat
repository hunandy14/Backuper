...
WinRAR.exe A "%~dp0\%username%-Skype.rar" Skype u –r -inul -m5 -agYYYYMMDD

::加入註解與修復紀錄3%
cd "%~dp0"
Echo SkypePatch = "%%USERPROFILE%%\AppData\Roaming\Skype" > SkypePatch.txt
WinRAR.exe c -zSkypePatch.txt "%~dp0\%username%-Skype.rar" -agYYYYMMDD
WinRAR.exe rr3p "%~dp0\%username%-Skype.rar" -agYYYYMMDD
