...
WinRAR.exe A "%~dp0\LiBK.rar" LINE u –r -inul -m5 -agYYYYMMDD-nn

::加入註解與修復紀錄3%
cd "%~dp0"
Echo LinePatch = "%%USERPROFILE%%\AppData\Local\LINE" > LinePatch.txt
WinRAR.exe c -zLinePatch.txt LiBK.rar -agYYYYMMDD-nn
WinRAR.exe rr3p LiBK.rar -agYYYYMMDD-nn

::解壓縮檔案到指定位置
cd "%USERPROFILE%\AppData\Local"
WinRAR.exe x "%~dp0\*Line*.rar" -r -o+
